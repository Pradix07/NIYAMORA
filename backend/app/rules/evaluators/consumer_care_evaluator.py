...
class ConsumerCareEvaluator(BaseRuleEvaluator):
    """
    Evaluates Rule 6(2): Consumer Care & Complaint Details:
    Name, address, telephone number, and e-mail address, if available, of the person or office that can be contacted in case of consumer complaints.
    """
